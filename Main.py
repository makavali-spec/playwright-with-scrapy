...
async def get_Data_Login(loginUrl, user, password, state):
  ...
  async with async_playwright() as page:
   ...
   # Go to redirect page
   await page.goto(f"https://foreclosures.al.com/listing/search?q={state}&lc=preforeclosure&pi=&pa=&bdi=&bhi=&loc={state}&boundingTopLeft=&boundingBottomRight=&st=&cno=&ci=&ps=100&pg=&o=&ob=&zip=&");
   # Get Usefull Data
